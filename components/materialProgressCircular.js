 ...
 */
class MaterialProgressCircular extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        const circularProgress = new MDCCircularProgress(this.querySelector('.mdc-circular-progress'))
        circularProgress.determinate = false
    }
}
customElements.define('material-progress-circular', MaterialProgressCircular);
